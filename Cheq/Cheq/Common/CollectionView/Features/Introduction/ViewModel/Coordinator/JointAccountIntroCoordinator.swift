//
//  JointAccountIntroCoordinator.swift
//  Cheq
//
...
class JointAccountIntroCoordinator: IntroductionCoordinatorProtocol {
    
    var type: IntroductionType = .jointAccount
    var caption: String = AppData.shared.declineDescription
    var title: String = IntroductionType.jointAccount.rawValue
