...
- (nonnull instancetype)initWithApiUrl:(NSString * _Nonnull)apiUrl apiReferrer:(NSString * _Nonnull)apiReferrer view:(UIView * _Nonnull)view isDebug:(BOOL)isDebug isBeta:(BOOL)isBeta serviceProvider:(enum Provider)serviceProvider aggregationTimeout:(NSInteger)aggregationTimeout OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
