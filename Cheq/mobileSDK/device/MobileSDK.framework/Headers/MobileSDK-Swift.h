...
- (void)getServicesWithInstitutionId:(NSInteger)institutionId listener:(ApiListListener<FinancialServiceModel *> * _Nonnull)listener;
...
///   </li>
///   <li>
///     financialAccount : A <code>FinancialAccountModel</code> representing the financial account which should be updated.
///   </li>
///   <li>
///     options : A <code>RefreshAccountOptions</code> which specified the options to take into account when performing the refresh.
///   </li>
///   <li>
///     listener : An <code>ApiListener</code> for a <code>FinancialAccountModel</code> representing the handler for when the request is complete.
///   </li>
/// </ul>
...
/// Refreshes the details of the specified accounts
/// <ul>
///   <li>
///     Parameters:
///   </li>
///   <li>
///     financialAccounts : A list of <code>FinancialAccountModel</code> representing the financial accounts which should be updated.
///   </li>
///   <li>
///     options : A <code>RefreshAccountOptions</code> which specifies the options to take into account when performing the refresh.
///   </li>
///   <li>
///     listener : An <code>ApiListListener</code> for <code>FinancialAccountModel</code> representing the handler for when the request is complete.
///   </li>
/// </ul>
...
/// <ul>
///   <li>
///     See: <code>FinancialApiProtocol.updateTransactions(...)</code>
///   </li>
/// </ul>
...
///   </li>
///   <li>
///     financialAccount : A <code>FinancialAccountModel</code> representing the financial account in which the transactions should be updated for.
///   </li>
///   <li>
///     listener : An <code>ApiListListener</code> for <code>FinancialTransactionModel</code>s representing the handler for when the request is complete.
///   </li>
/// </ul>
- (void)updateTransactionsWithFinancialAccount:(FinancialAccountModel * _Nonnull)financialAccount listener:(ApiListListener<FinancialTransactionModel *> * _Nonnull)listener;
/// Updates the transactions for the specified financial account.
/// <ul>
///   <li>
///     Parameters:
...
///   </li>
///   <li>
///     options : An <code>UpdateTransactionOptions</code> which specifies the options to take into account when performing the update
///   </li>
///   <li>
///     listener : An <code>ApiListListener</code> for <code>FinancialTransactionModel</code>s representing the handler for when the request is complete.
///   </li>
...
///   </li>
///   <li>
///     financialAccounts : A <code>FinancialAccountModel</code> list representing the financial accounts which the transactions should be updated for.
///   </li>
///   <li>
///     listener : An <code>ApiListListener</code> for <code>FinancialTransactionModel</code>s representing the handler for when the request is complete.
///   </li>
/// </ul>
- (void)updateTransactionsWithFinancialAccounts:(NSArray<FinancialAccountModel *> * _Nonnull)financialAccounts listener:(ApiListListener<FinancialTransactionModel *> * _Nonnull)listener;
/// Updates the transactions for the specified financial accounts.
/// <ul>
///   <li>
///     Parameters:
